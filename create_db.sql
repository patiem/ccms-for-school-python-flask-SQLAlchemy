...
CREATE TABLE `Sumbissions` ( `ID` INTEGER PRIMARY KEY AUTOINCREMENT, `ID_ASSIGMENT` TEXT NOT NULL, `ID_STUDENT` TEXT NOT NULL, `GRADE` INTEGER, `DATE` TEXT NOT NULL, `LINK` TEXT NOT NULL, `ID_MENTOR` TEXT);
